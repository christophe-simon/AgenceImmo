 ...
 */
final class Version20231021220243 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add role table. Add firstname and lastname fields to the user table and erase the roles field';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD firstname VARCHAR(255) NOT NULL, ADD lastname VARCHAR(255) NOT NULL, DROP roles');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL COMMENT \'(DC2Type:json)\', DROP firstname, DROP lastname');
    }
}
